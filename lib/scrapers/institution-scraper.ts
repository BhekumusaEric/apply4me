...
export class InstitutionScraper {
  ...
  private getMockInstitutions(source: any): ScrapedInstitution[] {
    const mockData: ScrapedInstitution[] = [
      {
        name: 'University of Johannesburg',
        type: 'university',
        location: 'Johannesburg, Gauteng',
        website: 'https://www.uj.ac.za',
        description: 'A leading South African university offering diverse academic programs',
      ...
      },
      {
        ...
        description: 'Technology-focused university with practical learning approach',
      ...
      },
      {
        ...
        description: 'Technical and vocational education and training college',
    ...
    return mockData.slice(0, Math.floor(Math.random() * mockData.length) + 1)
  }
